...
# KBosworth,12/3/2019, Modified script (more detail below)
# ---------------------------------------------------------- #
...
class EmployeeIO:
    ...
    changelog: (When,Who,What)
        ...
        KBosworth,12/3/2019,Modified print_current_list_items. Changed references of DC.Employee(row).X to row.X
    """
    @staticmethod
